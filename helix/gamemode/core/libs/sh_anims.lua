...
ix.anim.SetModelClass("models/wolfs_tactical.mdl", "player")
ix.anim.SetModelClass("models/lunawolves_chaplain.mdl", "player")
ix.anim.SetModelClass("models/wolfs_apothecary.mdl", "player")
ix.anim.SetModelClass("models/wolfs_assault.mdl", "player")
ix.anim.SetModelClass("models/wolfs_chaplain.mdl", "player")
ix.anim.SetModelClass("models/wolfs_devastator.mdl", "player")
ix.anim.SetModelClass("models/wolfs_honourguard.mdl", "player")
ix.anim.SetModelClass("models/wolfs_librarian.mdl", "player")
ix.anim.SetModelClass("models/wolfs_scout.mdl", "player")
ix.anim.SetModelClass("models/wolfs_techmarine.mdl", "player")
ix.anim.SetModelClass("models/wolfs_veteran.mdl", "player")
ix.anim.SetModelClass("models/malkiax/alptaros/wolfaros.mdl", "player")
ix.anim.SetModelClass("models/plyfix/lunawolvesn_terminator_cata.mdl", "player")
ix.anim.SetModelClass("models/alpha_infiltrator.mdl", "player")
ix.anim.SetModelClass("models/gipasist.mdl", "player")
ix.anim.SetModelClass("models/infiltrator.mdl", "player")
ix.anim.SetModelClass("models/keller.mdl", "player")
ix.anim.SetModelClass("models/magos.mdl", "player")
ix.anim.SetModelClass("models/mech_gispasist.mdl", "player")
ix.anim.SetModelClass("models/mech_new.mdl", "player")
ix.anim.SetModelClass("models/rander.mdl", "player")
ix.anim.SetModelClass("models/rander_alpha.mdl", "player")
ix.anim.SetModelClass("models/ruststalker.mdl", "player")
ix.anim.SetModelClass("models/ruststalker_alpha.mdl", "player")
ix.anim.SetModelClass("models/secutarii.mdl", "player")
ix.anim.SetModelClass("models/servitor.mdl", "player")
ix.anim.SetModelClass("models/tech_priest.mdl", "player")
ix.anim.SetModelClass("models/tech_priest_l.mdl", "player")
ix.anim.SetModelClass("models/vanguard.mdl", "player")
ix.anim.SetModelClass("models/vanguard_alpha.mdl", "player")
ix.anim.SetModelClass("models/kuma96/marinecombatarmor_male/marinecombatarmor_male_pm.mdl", "player")
ix.anim.SetModelClass("models/kuma96/marinecombatarmor_female/marinecombatarmor_female_pm.mdl", "player")
