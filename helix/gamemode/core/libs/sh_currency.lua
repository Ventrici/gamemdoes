...
ix.currency.singular = ix.currency.singular or "Throne"
ix.currency.plural = ix.currency.plural or "Thrones"
ix.currency.model = ix.currency.model or "models/kali/props/cases/hard case b.mdl"
